page 50162 "BVR Sales Inv Batch Subform"
{
    // The "lines" of a sales invoice batch: the RELEASED invoices carrying this batch no.
    // Rows are multi-selectable, and the parent page posts whatever is selected.
    //
    // Released only, because this is a posting screen - an invoice still being worked on cannot be
    // posted. The "No. of Sales Invoices" count on the header still counts every one in the
    ...
    layout
    {
        area(content)
        {
            repeater(Gen)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the customer the invoice is for.';
                }
                field("Sell-to Customer Name"; Rec."Sell-to Customer Name")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the name of the customer the invoice is for.';
                }
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the total amount of the invoice including VAT. These are the figures the batch total adds up.';
                }
    ...
    actions
    {
        area(processing)
        {
            action("BVR Open Sales Invoice")
            {
                ...
                ToolTip = 'Open the selected sales invoice to review it before posting.';
            }
        }
    }
